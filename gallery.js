  ...
  return `
    <div class="card" style="padding:8px;${isSelected?'border:2px solid var(--violet)':''}">
      ...
      <div style="display:flex;gap:3px;margin-top:3px">
        ...
        <button class="vc-result-icon-btn" style="width:28px;height:28px;border-radius:8px" title="Details" data-meta="${jsonAttr({prompt:a.prompt||"",assetId:a.id,mediaUrl:a.url,mediaType:a.type,model:a.model||"",providerLabel:a.providerLabel||a.type,resolution:a.resolution||"",aspectRatio:a.aspectRatio||"",duration:a.duration||""})}" onclick="openGenerationInfoModalFromCard(this)">${VC_RESULT_ICONS.info}</button>
