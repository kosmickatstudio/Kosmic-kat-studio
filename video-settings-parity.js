...
(function installVideoSettingsParity(){
  ...
  if(!document.querySelector('link[data-kosmic-ui-v2-phase="8"]')){
    const css=document.createElement("link");css.rel="stylesheet";css.href="ui-v2-phase8.css";css.dataset.kosmicUiV2Phase="8";document.head.appendChild(css);
  }
  if(!document.querySelector('link[data-kosmic-evo-video-css="1"]')){
    const css=document.createElement("link");css.rel="stylesheet";css.href="ui-v2-evolink-video.css";css.dataset.kosmicEvoVideoCss="1";document.head.appendChild(css);
  }
