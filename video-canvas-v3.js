...
(function installVideoCanvasV3(){
  ...
  function bind(){
    ...
    $("kkv3Generate")?.addEventListener("click",generate);$("kkv3GenerateMobile")?.addEventListener("click",generate);$("kkVideoCanvasV3 [data-stable-generate]")?.addEventListener("click",generate);$("kkVideoCanvasV3 [data-kosmic-video-gallery]")?.addEventListener("click",()=>{const target=document.querySelector('.mod-btn[data-mod="gallery"]');if(typeof window.switchMod==="function")window.switchMod("gallery",target);});$("kkVideoCanvasV3 [data-kosmic-video-assets]")?.addEventListener("click",()=>{if(typeof window.__kosmicVideoOpenAssetPicker==="function")window.__kosmicVideoOpenAssetPicker();});$("kkv3StoryboardGenerate")?.addEventListener("click",generateStoryboard);
